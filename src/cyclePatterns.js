...
export const PATTERNS = [
  ...
  { id: 'cold_sky',
    name: 'Cold Sky',
    voice: 'sera',
    desc: 'Carrier windows arrive shorter than usual, but every one of them runs at twice the strength.',
    gameplay: 'Purchased rate windows: ×2 strength, ×0.5 duration.',
    buffDurationMul: 0.5,
  ...
  { id: 'patched_frame',
    name: 'Patched Frame',
    voice: 'sera',
    desc: 'Three bands ride free at cycle open. Every re-tune after that bills double.',
    gameplay: 'First three non-hail purchases are free. Re-tune costs are doubled.',
    freePurchases: 3,
    rerollCostMul: 2.0,
  },
