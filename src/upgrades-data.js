...
export const UPGRADES = [
  ...
  { id: 'insurance', kind: 'buff', rarity: 'common', buffType: 'gambleCushion', group: 'burst',
    name: 'Failsafe Buffer', desc: 'A refund on a misfire. 5% return, 3 min.',
    refund: 0.05, duration: 180, costSec: 100 },
  ...
  { id: 'steady',    kind: 'buff', rarity: 'uncommon', buffType: 'gambleCushion', group: 'burst',
    name: 'Error-Correction', desc: 'Most wasted bits come home. 9% return, 5 min.',
    refund: 0.09, duration: 300, costSec: 200 },
  ...
  { id: 'iron_will', kind: 'buff', rarity: 'rare', buffType: 'gambleCushion', group: 'burst',
    name: 'Hardened Stack', desc: 'Failures hurt less. 14% return, 5 min.',
    refund: 0.14, duration: 300, costSec: 400 },
  ...
  { id: 'bastion',   kind: 'buff', rarity: 'rare', buffType: 'gambleCushion', group: 'long',
    name: 'Shield Net',   desc: 'Twelve hours of partial refunds on a loss. 10% return.',
    refund: 0.10, duration: 86400, costSec: 3000 },
  ...
  { id: 'last_stand', kind: 'buff', rarity: 'legendary', buffType: 'gambleCushion', group: 'burst',
    name: 'Final Buffer', desc: 'Ninety seconds of generous cushion. 30% return.',
    refund: 0.30, duration: 90, costSec: 800 },
  ...
  { id: 'vigil_coil', kind: 'coil', rarity: 'uncommon',
    name: 'Vigil Coil',
    desc: 'Quiets the rig while away. Relays stay hidden longer.',
