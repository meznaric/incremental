...
export const UPGRADES = [
  ...
  { id: 'low_tide',  kind: 'buff', rarity: 'common', buffType: 'rateMul', group: 'long',
    name: 'Low Tide',     desc: 'One hour of clean band-floor. You are sitting on quiet water. 1.08× rate.',
    mult: 1.08, duration: 3600, costSec: 280 },
  { id: 'morning_drift', kind: 'buff', rarity: 'common', buffType: 'rateMul', group: 'long',
    name: 'Morning Drift', desc: 'Two hours before the sky wakes up. Nothing on the air but me. 1.05× rate.',
    mult: 1.05, duration: 7200, costSec: 360 },
  ...
  { id: 'quiet_shift', kind: 'buff', rarity: 'uncommon', buffType: 'rateMul', group: 'long',
    name: 'Quiet Shift',  desc: 'A three-hour stretch with the relay tuned tight. 1.1× rate.',
    mult: 1.1, duration: 10800, costSec: 800 },
  ...
  { id: 'side_gig',  kind: 'convert', rarity: 'uncommon',
    name: 'Hidden Antenna', desc: 'Burn 10% balance — off-books, off-grid. +0.1% of spent /s.',
    pctCost: 0.10, ratio: 0.001 },
  { id: 'franchise', kind: 'convert', rarity: 'rare',
    name: 'Buried Array', desc: 'Burn 25% balance — a real installation. +0.4% of spent /s.',
    pctCost: 0.25, ratio: 0.004 },
  { id: 'empire',    kind: 'convert', rarity: 'legendary',
    name: 'Forbidden Network', desc: 'Burn ALL balance — somewhere they cannot find. +1% of spent /s.',
    pctCost: 1.0,  ratio: 0.01 },
  { id: 'vending',   kind: 'convert', rarity: 'common',
    name: 'Seed Coil', desc: 'Burn 2% balance — a coil you bury and forget. +0.006% of spent /s.',
    pctCost: 0.02, ratio: 0.00006 },
  { id: 'kiosk',     kind: 'convert', rarity: 'uncommon',
    name: 'Quiet Outpost', desc: 'Burn 7% balance — a small staffed listening post. +0.05% of spent /s.',
    pctCost: 0.07, ratio: 0.0005 },
  { id: 'conglomerate', kind: 'convert', rarity: 'rare',
    name: 'Distributed Mesh', desc: 'Burn 50% balance — a network you cannot lose all of. +0.75% of spent /s.',
