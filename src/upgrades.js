...
export const UPGRADES = [
  ...
  { id: 'plus_two',     kind: 'permanent', rarity: 'common', permType: 'add',
    ...
    value: 2,    baseCost: 25,     growth: 1.18 },
  { id: 'mult5',        kind: 'permanent', rarity: 'common', permType: 'mul',
    name: '+5% Multiplier',    desc: 'Permanent ×1.05 to rate',
    value: 1.05, baseCost: 250,    growth: 2.5 },
  { id: 'plus_fifty',   kind: 'permanent', rarity: 'uncommon', permType: 'add',
    name: '+50 per second',    desc: 'Permanent +50 to base rate',
    value: 50,   baseCost: 5000,   growth: 1.4 },
  { id: 'mult33',       kind: 'permanent', rarity: 'uncommon', permType: 'mul',
    name: '+33% Multiplier',   desc: 'Permanent ×1.33 to rate',
    value: 1.33, baseCost: 12000,  growth: 3.5 },
  { id: 'plus_thousand', kind: 'permanent', rarity: 'legendary', permType: 'add',
    name: '+1k per second',    desc: 'Permanent +1000 to base rate',
    value: 1000, baseCost: 1e6,    growth: 1.7 },
