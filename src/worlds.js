...
//
// Images: ten existing canonical portraits live under docs/lore/images/. New
// worlds use `image: null` — the interstitial overlay falls back to the
// stylised CSS portrait. Run docs/lore/scripts/gen-images.py later to mint
// the missing portraits; the prompts to feed it live in image-style-guide.md.
